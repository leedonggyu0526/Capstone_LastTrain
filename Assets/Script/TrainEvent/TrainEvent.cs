...
// 이벤트 구조체
// 이벤트 이름, 이벤트 설명, 이벤트 이미지, 이벤트 선택지 1, 이벤트 선택지 2, 이벤트 선택지 3, 각 선택지 설명
...
public class TrainEvent
{
    ...
    public TrainEvent(Sprite eventImage, string eventName, string eventDescription, string eventChoice1, string eventChoice1Description, string eventChoice2, string eventChoice2Description, string eventChoice3, string eventChoice3Description)
    {
